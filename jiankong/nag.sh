...
sed -i "28anrpe            5666/tcp                # nrpe" /etc/services

sed -i "s#hda1#vda1#g" /usr/local/nagios/etc/nrpe.cfg
sed -i "203acommand[check_swap]=/usr/local/nagios/libexec/check_swap -w 20% -c 10%" /usr/local/nagios/etc/nrpe.cfg
...
sed -i "36acfg_file=/etc/nagios/objects/serverb.cfg" /etc/nagios/nagios.cfg
sed -i "37acfg_file=/etc/nagios/objects/serverc.cfg" /etc/nagios/nagios.cfg
